...
export default function TotalSpent(props: { [x: string]: any }) {
	...
	interface BgColor {
	  ...
	  const bgHover: BgColor = useColorModeValue({ bg: 'secondaryGray.400' }, { bg: 'whiteAlpha.50' });
	  const bgFocus: BgColor = useColorModeValue({ bg: 'secondaryGray.300' }, { bg: 'whiteAlpha.100' });
