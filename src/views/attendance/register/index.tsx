...
//   document: string | null;
//   state: string;
//   location: { latitude: number; longitude: number } | string; // Corrected type here
//   photo: string;
// }
...
//   document: '',
//   state: '',
//   location: { latitude: 0, longitude: 0 }, // Set default values or leave it empty
//   photo: '',
// };
...
//   const handleSubmit = async (values: FormValues) => {
//     if (values.document === '' || values.state === '' || !userLocation) {
//       Swal.fire({
//         icon: 'error',
//         title: 'Oops...',
//         text: 'Todos los campos son obligatorios y la ubicación es necesaria!',
//       });
//     } else {
//       const imageSrc = webcamRef.current.getScreenshot();
